  ...
  const renderBoardView = () => (
    <div className="max-w-6xl mx-auto">
      <div className="text-center mb-8 sm:mb-12">
        ...
        <p className="text-slate-600 text-sm sm:text-base max-w-2xl mx-auto">
          상암동 맛집에 대한 정보를 공유하고 소통해보세요
        </p>
      </div>
      <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-6 sm:p-8 border border-white/20">
        <div className="space-y-4 sm:space-y-6">
          {[
            { title: "오늘 점심 뭐 먹었어요? 🍽️", date: "2024.01.15", views: 42 },
            { title: "상암동 맛집 추천해주세요!", date: "2024.01.14", views: 28 },
            { title: "새로 오픈한 카페 후기", date: "2024.01.13", views: 35 },
            { title: "회식 장소 추천 부탁드려요", date: "2024.01.12", views: 19 },
            { title: "상암동 숨은 맛집 발견!", date: "2024.01.11", views: 56 },
            { title: "점심시간 줄서기 없는 곳", date: "2024.01.10", views: 31 }
          ].map((post, index) => (
            <div key={index} className="group p-4 sm:p-6 bg-gradient-to-r from-slate-50 to-blue-50 hover:from-blue-50 hover:to-indigo-50 rounded-2xl transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg border border-slate-200 hover:border-blue-300">
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                  <h3 className="text-base sm:text-lg font-semibold text-slate-800 mb-2 group-hover:text-blue-600 transition-colors duration-300 leading-tight">
                    {post.title}
                  </h3>
                ...
                <svg className="w-5 h-5 text-slate-400 group-hover:text-blue-500 group-hover:translate-x-1 transition-all duration-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 text-center">
          <button className="group px-8 py-4 bg-blue-600 text-white rounded-2xl hover:bg-blue-700 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl transform hover:scale-105">
